...
<section class="category-list-section">
    <article class="container">
            ...
            <form>
                ...
                <div class="other-fields">
                    ...
                    <div class="filter">
                        <ul>
                            <li>
                                <a href="{{ route($local.'.category',$category->slug) }}" style="cursor: pointer;">{{ __("Clear Filter") }}</a>
                            </li>
                            <li>
                                ...
                                <div class="products-list_details">
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <li>
                                                <a href="javascript:;" class="add-to-wishlist active" data-product_id="{{ $product->id }}" data-custom_id="{{ $product->custom_id }}"><img src="{{ asset('frontend/images/heart-sprite.svg') }}" alt="{{ __('Wishlist') }}"></a>
                                            </li>
                                            @else
                                            <li id="product_favourite">
                                                <a href="javascript:;" class="add-to-wishlist" data-product_id="{{ $product->id }}" data-custom_id="{{ $product->custom_id }}"><img src="{{ asset('frontend/images/heart-sprite.svg') }}" alt="{{ __('Wishlist') }}"></a>
                                            </li>
                                            @endif
                                        </li>
                                    </ul>
        ...
        @else
        <div id="filterProducts">
            <center><p>{{ __("No Products Found.") }}</p></center>
        </div>
        @endif
    </article>
</section>      
...
<script type="text/javascript" src="{{ asset('frontend/js/jcf.scrollable.js') }}"></script>
  <script>
        $(document).ready(function () {
            ...
            //     var route = "{{ route($local.'.category',$breadcumb_category_slug) }}";
            ...
            $("#search").keyup(function(){
                ...
                if( $(this).val().length >= 3 ){
                    ...
                    $.ajax({
                        type: 'GET',
                        dataType: 'JSON',
                        url: "{{ route($local.'.category',$category->slug) }}",
                        data: {
                            search              :   search,
                            shape_id            :   shape_id,
                            color_id            :   color_id,
