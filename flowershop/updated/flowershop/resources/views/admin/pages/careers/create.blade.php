...
@push('breadcrumb')
    {!! Breadcrumbs::render('careers_create') !!}
@endpush
	...
	<div class="row">
        <div class="col-md-12">
            <div class="profile-content">
                <form action="{{ route('admin.careers.store') }}" role="form" id="frmAddNewCareer" name="frmAddNewCareer" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-6">
                        <div class="portlet light ">
                            ...
                            <div class="portlet-body">
                                    ...
                                    <div class="form-group {{ $errors->has('en_title') ? 'has-error' : '' }}">
                                        ...
                                        <input type="text" placeholder="Enter Title Here" class="form-control" id="en_title" name="en_title" maxlength="50" autocomplete="off" value="{{ old('en_title', '') }}" />
                                    ...
                                    <div class="form-group {{ $errors->has('en_sort_description') ? 'has-error' : '' }}">
                                        ...
                                        <textarea placeholder="Enter Short Details Here" class="form-control" id="en_sort_description" name="en_sort_description"  autocomplete="off" data-error-container="#error-en-sort-description">{!! old('en_sort_description', '') !!}</textarea>
                                    ...
                                    <div class="form-group {{ $errors->has('en_description') ? 'has-error' : '' }}">
                                        ...
                                        <textarea placeholder="Enter Short Details Here" class="form-control" id="en_description" name="en_description"  autocomplete="off" data-error-container="#error-en-description">{!! old('en_description', '') !!}</textarea>
                        ...
                        <div class="portlet light ">
                            ...
                            <div class="portlet-body">
                                    ...
                                    <div class="form-group {{ $errors->has('ar_title') ? 'has-error' : '' }}">
                                        <label class="control-label">{!! $mend_sign !!}Title</label>
                                        <input type="text" placeholder="Enter Title Here" class="form-control" id="ar_title" name="ar_title" maxlength="50" autocomplete="off" value="{{ old('ar_title', '') }}" />
                                    ...
                                    <div class="form-group {{ $errors->has('ar_sort_description') ? 'has-error' : '' }}">
                                        <label class="control-label">{!! $mend_sign !!}Sort Description</label>
                                        <textarea placeholder="Enter Short Details Here" class="form-control" id="ar_sort_description" name="ar_sort_description"  autocomplete="off" data-error-container="#error-ar-sort-description">{!! old('ar_sort_description', '') !!}</textarea>
                                    ...
                                    <div class="form-group {{ $errors->has('ar_description') ? 'has-error' : '' }}">
                                        <label class="control-label">{!! $mend_sign !!}Description</label>
                                        <textarea placeholder="Enter Short Details Here" class="form-control" id="ar_description" name="ar_description"  autocomplete="off" data-error-container="#error-ar-description">{!! old('ar_description', '') !!}</textarea>
...
@push('extra-js')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#frmAddNewCareer').submit(function(){
                if( $(this).valid() ){
                    addOverlay();
