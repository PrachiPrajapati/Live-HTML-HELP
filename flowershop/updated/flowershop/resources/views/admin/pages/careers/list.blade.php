...
@push('breadcrumb')
    {!! Breadcrumbs::render('careers_list') !!}
@endpush
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase"> Total Careers : <span id="totalCount">{{ $count ?? 0 }}</span> </span>
                    </div>
                    <div class="actions">
                        <div class="btn-group btn-group-devided">

                            @if (in_array('delete', $permissions))
                            <a href="{{ route('admin.careers.destroy',0) }}" name="del_select" id="del_select" class="btn btn-sm btn-danger delete_all_link"><i class="fa fa-trash"></i> Delete Selected {{ $title }}</a>
                            @endif
                ...
                <div class="portlet-body">
                    <table class="table table-striped table-bordered table-hover table-checkable" id="careersList">
                    </table>
                </div>
            </div>
    ...
    <script type="text/javascript">
        $(function(){
            ...
            oTable = table.dataTable({
                ...
                "pageLength": 10,
                "ajax": {
                    "url": "{{route('admin.careers.listing')}}", // ajax source
                },
