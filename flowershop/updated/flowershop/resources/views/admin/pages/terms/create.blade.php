...
@push('breadcrumb')
    {!! Breadcrumbs::render('terms_create') !!}
@endpush
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="profile-content">
                <form action="{{ route('admin.terms.store') }}" role="form" id="frmAddTerms" name="frmAddTerms" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-6">
