            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase"> Total Terms & COnditions : <span id="totalCount">{{ $count ?? 0 }}</span> </span>
                    </div>
                    <div class="actions">
                        <div class="btn-group btn-group-devided">

                            @if (in_array('delete', $permissions))
                            <a href="{{ route('admin.terms.destroy',0) }}" name="del_select" id="del_select" class="btn btn-sm btn-danger delete_all_link"><i class="fa fa-trash"></i> Delete Selected {{ $title }}</a>
                            @endif
                            @if (in_array('add', $permissions))
                            <a href="{{ route('admin.terms.create') }}" class="btn btn-info">
                                Add New {{ $title }}
                            </a>
                            @endif
                        </div>
    ...
    <script type="text/javascript">
        $(function(){
            ...
            oTable = table.dataTable({
                ...
                "pageLength": 10,
                "ajax": {
                    "url": "{{route('admin.terms.listing')}}", // ajax source
                },
