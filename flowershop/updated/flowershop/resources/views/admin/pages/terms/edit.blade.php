...
@push('breadcrumb')
    {!! Breadcrumbs::render('terms_update') !!}
@endpush

@push('page-title')
	<h3 class="page-title"> 
        Edit {{ strtolower(str_singular($title)) }}
	</h3>
@endpush
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="profile-content">
                <form action="{{ route('admin.terms.update',$terms->id) }}" role="form" id="frmEditTerms" name="frmEditTerms" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')    
                    <div class="col-md-6">
                        <div class="portlet light ">
                            ...
                            <div class="portlet-body">
                                    ...
                                    <div class="form-group {{ $errors->has('en_title') ? 'has-error' : '' }}">
                                        ...
                                        <input type="text" value="{{ old('en_title',$terms->en_title) }}" placeholder="Enter Title Here" class="form-control" id="en_title" name="en_title" maxlength="50" autocomplete="off" />
                                    ...
                                    <div class="form-group {{ $errors->has('en_details') ? 'has-error' : '' }}">
                                        ...
                                        <textarea placeholder="Enter Details Here" class="form-control" id="en_details" name="en_details"  autocomplete="off" data-error-container="#error-en-detail">{{ old('en_details',$terms->en_details) }}</textarea>
                        ...
                        <div class="portlet light ">
                            ...
                            <div class="portlet-body">
                                    ...
                                    <div class="form-group {{ $errors->has('ar_title') ? 'has-error' : '' }}">
                                        <label class="control-label">{!! $mend_sign !!}Title</label>
                                        <input type="text" value="{{ old('ar_title',$terms->ar_title) }}" placeholder="Enter Title Here" class="form-control" id="ar_title" name="ar_title" maxlength="50" autocomplete="off" />
                                    ...
                                    <div class="form-group {{ $errors->has('ar_details') ? 'has-error' : '' }}">
                                        <label class="control-label">{!! $mend_sign !!}Details</label>
                                        <textarea placeholder="Enter Short Details Here" class="form-control" id="ar_details" name="ar_details"  autocomplete="off" data-error-container="#error-en-description">{{ old('ar_details',$terms->ar_details) }}</textarea>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-xs-6">
                                <a href="{{ route('admin.terms.index') }}" class="btn default">Cancel</a>
                            </div>
                        </div>
                    </div>
                </form>
