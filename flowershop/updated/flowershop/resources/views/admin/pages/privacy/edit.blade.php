...
@push('breadcrumb')
    {!! Breadcrumbs::render('privacy_update') !!}
@endpush
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="profile-content">
                <form action="{{ route('admin.privacy.update',$privacy->id) }}" role="form" id="frmEditPrivacyPolicy" name="frmEditPrivacyPolicy" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')    
                    <div class="col-md-6">
                        <div class="portlet light ">
                            ...
                            <div class="portlet-body">
                                    ...
                                    <div class="form-group {{ $errors->has('en_title') ? 'has-error' : '' }}">
                                        ...
                                        <input type="text" value="{{ old('en_title',$privacy->en_title) }}" placeholder="Enter Title Here" class="form-control" id="en_title" name="en_title" maxlength="50" autocomplete="off" />
                                    ...
                                    <div class="form-group {{ $errors->has('en_details') ? 'has-error' : '' }}">
                                        ...
                                        <textarea placeholder="Enter Details Here" class="form-control" id="en_details" name="en_details"  autocomplete="off" data-error-container="#error-en-detail">{{ old('en_details',$privacy->en_details) }}</textarea>
                        ...
                        <div class="portlet light ">
                            ...
                            <div class="portlet-body">
                                    ...
                                    <div class="form-group {{ $errors->has('ar_title') ? 'has-error' : '' }}">
                                        <label class="control-label">{!! $mend_sign !!}Title</label>
                                        <input type="text" value="{{ old('ar_title',$privacy->ar_title) }}" placeholder="Enter Title Here" class="form-control" id="ar_title" name="ar_title" maxlength="50" autocomplete="off" />
                                    ...
                                    <div class="form-group {{ $errors->has('ar_details') ? 'has-error' : '' }}">
                                        <label class="control-label">{!! $mend_sign !!}Details</label>
                                        <textarea placeholder="Enter Short Details Here" class="form-control" id="ar_details" name="ar_details"  autocomplete="off" data-error-container="#error-en-description">{{ old('ar_details',$privacy->ar_details) }}</textarea>
...
@push('extra-js')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#frmEditPrivacyPolicy').submit(function(){
                if( $(this).valid() ){
                    addOverlay();
