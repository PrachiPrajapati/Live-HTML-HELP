...
@push('breadcrumb')
    {!! Breadcrumbs::render('privacy_list') !!}
@endpush
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase"> Total Privacy Policy : <span id="totalCount">{{ $count ?? 0 }}</span> </span>
                    </div>
                    <div class="actions">
                        <div class="btn-group btn-group-devided">

                            @if (in_array('delete', $permissions))
                            <a href="{{ route('admin.privacy.destroy',0) }}" name="del_select" id="del_select" class="btn btn-sm btn-danger delete_all_link"><i class="fa fa-trash"></i> Delete Selected {{ $title }}</a>
                            @endif
                            @if (in_array('add', $permissions))
                            <a href="{{ route('admin.privacy.create') }}" class="btn btn-info">
                                Add New {{ $title }}
                            </a>
                            @endif
                        </div>
                ...
                <div class="portlet-body">
                    <table class="table table-striped table-bordered table-hover table-checkable" id="faqsList">
                    </table>
                </div>
            </div>
        ...
        $(function(){
            ...
            oTable = table.dataTable({
                ...
                "columns": [
                    ...
                    @endif
                    { "title": "TItle (English)" ,"data": "en_title", render: $.fn.dataTable.render.text(),},
                ...
                "pageLength": 10,
                "ajax": {
                    "url": "{{route('admin.privacy.listing')}}", // ajax source
                },
