...
@push('breadcrumb')
    {!! Breadcrumbs::render('events_update') !!}
@endpush
	...
	<div class="row">
        <div class="col-md-12">
            <div class="profile-content">
                <form action="{{ route('admin.services.update',$service->id) }}" role="form" id="frmAddNewService" name="frmAddNewService" method="POST" enctype="multipart/form-data">
                    @csrf @method('PUT')
                    <div class="col-md-6">
                        <div class="portlet light ">
                            ...
                            <div class="portlet-body">
                                    ...
                                    <div class="form-group {{ $errors->has('en_title') ? 'has-error' : '' }}">
                                        ...
                                        <input type="text" placeholder="Enter Event Title Here" class="form-control" id="en_title" name="en_title" maxlength="50" autocomplete="off" value="{{ old('en_title',$service->en_title) }}" />
                                    ...
                                    @if ($service->en_banner && Storage::exists($service->en_banner))
                                        @php $exists = true @endphp
                                        <div class="form-group">
                                            <label class="control-label">Current Image</label>
                                            <div class="show-image">
                                                <img class="img img-thumbnail" style="height: 75px; width: 75px;" src="{{ generateURL($service->en_banner)}}" alt="image-not-found">
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    <div class="form-group {{ $errors->has('en_description') ? 'has-error' : '' }}">
                                        ...
                                        <textarea placeholder="Enter Short Description Here" rows="3" class="form-control" id="en_description" name="en_description"  autocomplete="off" data-error-container="#error-en-description">{!! old('en_description',$service->en_description) !!}</textarea>
                            ...
                            <div class="portlet-title tabbable-line">
                                <div class="caption caption-md">
                                    ...
                                    <div class="form-group {{ $errors->has('en_section_1_title') ? 'has-error' : '' }}">
                                        <label class="control-label">{!! $mend_sign !!}Title</label>
                                        <input type="text" placeholder="Enter Event Title Here" class="form-control" id="en_section_1_title" name="en_section_1_title" maxlength="50" autocomplete="off" value="{{ old('en_section_1_title',$service->en_section_1_title) }}" />
                                    ...
                                    @php $exists = false @endphp
                                    @if ($service->en_section_1_image && Storage::exists($service->en_section_1_image))
                                        @php $exists = true @endphp
                                        <div class="form-group">
                                            <label class="control-label">Current Image</label>
                                            <div class="show-image">
                                                <img class="img img-thumbnail" style="height: 75px; width: 75px;" src="{{ generateURL($service->en_section_1_image)}}" alt="image-not-found">
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    <div class="form-group {{ $errors->has('en_section_1_description') ? 'has-error' : '' }}">
                                        <label class="control-label">{!! $mend_sign !!}Description</label>
                                        <textarea placeholder="Enter Short Description Here" rows="3" class="form-control" id="en_section_1_description" name="en_section_1_description"  autocomplete="off" data-error-container="#error-en-section-1-description">{!! old('en_section_1_description', $service->en_section_1_description) !!}</textarea>
                            ...
                            <div class="portlet-title tabbable-line">
                                <div class="caption caption-md">
                                    ...
                                    <div class="form-group {{ $errors->has('en_section_2_title') ? 'has-error' : '' }}">
                                        <label class="control-label">{!! $mend_sign !!}Title</label>
                                        <input type="text" placeholder="Enter Event Title Here" class="form-control" id="en_section_2_title" name="en_section_2_title" maxlength="50" autocomplete="off" value="{{ old('en_section_2_title', $service->en_section_2_title) }}" />
                                    ...
                                    @php $exists = false @endphp
                                    @if ($service->en_section_2_image && Storage::exists($service->en_section_2_image))
                                        @php $exists = true @endphp
                                        <div class="form-group">
                                            <label class="control-label">Current Image</label>
                                            <div class="show-image">
                                                <img class="img img-thumbnail" style="height: 75px; width: 75px;" src="{{ generateURL($service->en_section_2_image)}}" alt="image-not-found">
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    <div class="form-group {{ $errors->has('en_section_2_description') ? 'has-error' : '' }}">
                                        <label class="control-label">{!! $mend_sign !!}Description</label>
                                        <textarea placeholder="Enter Short Description Here" rows="3" class="form-control" id="en_section_2_description" name="en_section_2_description"  autocomplete="off" data-error-container="#error-en-section-2-description">{!! old('en_section_2_description', $service->en_section_2_description) !!}</textarea>
                        ...
                        <div class="portlet light ">
                            ...
                            <div class="portlet-body">
                                    ...
                                    <div class="form-group {{ $errors->has('ar_title') ? 'has-error' : '' }}">
                                        <label class="control-label">{!! $mend_sign !!}Title</label>
                                        <input type="text" placeholder="Enter Event Title Here" class="form-control" id="ar_title" name="ar_title" maxlength="50" autocomplete="off" value="{{ old('ar_title', $service->ar_title) }}" />
                                    ...
                                    @php $exists = false @endphp
                                    @if ($service->ar_banner && Storage::exists($service->ar_banner))
                                        @php $exists = true @endphp
                                        <div class="form-group">
                                            <label class="control-label">Current Image</label>
                                            <div class="show-image">
                                                <img class="img img-thumbnail" style="height: 75px; width: 75px;" src="{{ generateURL($service->ar_banner)}}" alt="image-not-found">
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    <div class="form-group {{ $errors->has('ar_description') ? 'has-error' : '' }}">
                                        <label class="control-label">{!! $mend_sign !!}Description</label>
                                        <textarea placeholder="Enter Short Description Here" rows="3" class="form-control" id="ar_description" name="ar_description"  autocomplete="off" data-error-container="#error-ar-description">{!! old('ar_description', $service->ar_description) !!}</textarea>
                            ...
                            <div class="portlet-title tabbable-line">
                                <div class="caption caption-md">
                                    ...
                                    <div class="form-group {{ $errors->has('ar_section_1_title') ? 'has-error' : '' }}">
                                        <label class="control-label">{!! $mend_sign !!}Title</label>
                                        <input type="text" placeholder="Enter Event Title Here" class="form-control" id="ar_section_1_title" name="ar_section_1_title" maxlength="50" autocomplete="off" value="{{ old('ar_section_1_title', $service->ar_section_1_title) }}" />
                                    ...
                                    @php $exists = false @endphp
                                    @if ($service->ar_section_1_image && Storage::exists($service->ar_section_1_image))
                                        @php $exists = true @endphp
                                        <div class="form-group">
                                            <label class="control-label">Current Image</label>
                                            <div class="show-image">
                                                <img class="img img-thumbnail" style="height: 75px; width: 75px;" src="{{ generateURL($service->ar_section_1_image)}}" alt="image-not-found">
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    <div class="form-group {{ $errors->has('ar_section_1_description') ? 'has-error' : '' }}">
                                        <label class="control-label">{!! $mend_sign !!}Description</label>
                                        <textarea placeholder="Enter Short Description Here" rows="3" class="form-control" id="ar_section_1_description" name="ar_section_1_description"  autocomplete="off" data-error-container="#error-ar-section-1-description">{!! old('ar_section_1_description', $service->ar_section_1_description) !!}</textarea>
                            ...
                            <div class="portlet-title tabbable-line">
                                <div class="caption caption-md">
                                    ...
                                    <div class="form-group {{ $errors->has('ar_section_2_title') ? 'has-error' : '' }}">
                                        <label class="control-label">{!! $mend_sign !!}Title</label>
                                        <input type="text" placeholder="Enter Event Title Here" class="form-control" id="ar_section_2_title" name="ar_section_2_title" maxlength="50" autocomplete="off" value="{{ old('ar_section_2_title', $service->ar_section_2_title) }}" />
                                    ...
                                    @php $exists = false @endphp
                                    @if ($service->ar_section_2_image && Storage::exists($service->ar_section_2_image))
                                        @php $exists = true @endphp
                                        <div class="form-group">
                                            <label class="control-label">Current Image</label>
                                            <div class="show-image">
                                                <img class="img img-thumbnail" style="height: 75px; width: 75px;" src="{{ generateURL($service->ar_section_2_image)}}" alt="image-not-found">
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    <div class="form-group {{ $errors->has('ar_section_2_description') ? 'has-error' : '' }}">
                                        <label class="control-label">{!! $mend_sign !!}Description</label>
                                        <textarea placeholder="Enter Short Description Here" rows="3" class="form-control" id="ar_section_2_description" name="ar_section_2_description"  autocomplete="off" data-error-container="#error-ar-section-2-description">{!! old('ar_section_2_description', $service->ar_section_2_description) !!}</textarea>
                                 ...
                                 <div class="col-sm-12 col-sm-offset-0">
                                        ...
                                        <div id="EventGroup">
                                            ...
                                            <div id="eventInformation">
                                                ...
                                                <button type="button" class="btn btn-success btninner" data-count="0" id="addEvent">+</button>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" placeholder="Enter Event Title Here" class="form-control" id="en_title_showcase" name="en_title_showcase[]" maxlength="50" autocomplete="off" value="{{ old('en_title_showcase[]', $showcase->en_title) }}" />
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" placeholder="Enter Event Title Here" class="form-control" id="ar_title_showcase" name="ar_title_showcase[]" maxlength="50" autocomplete="off" value="{{ old('ar_title_showcase[]', $showcase->ar_title) }}" />
                                                ...
                                                @php $exists = false @endphp
                                                @if ($showcase->image && Storage::exists($showcase->image))
                                                    @php $exists = true @endphp
                                                    <div class="form-group">
                                                        <label class="control-label">Current Image</label>
                                                        <div class="show-image">
                                                            <img class="img img-thumbnail" style="height: 75px; width: 75px;" src="{{ generateURL($showcase->image)}}" alt="image-not-found">
                                                            </div>
                                                        </div>
                                                    @endif
                                                ...
                                                {{-- Psssing Custom ID --}}
                                                    <input type="text" name="custom_id[]" value="{{ $showcase->custom_id }}" style="display: none;">

                                                    <div id=emaildiv class="col-sm-11"></div>
                                                        <button type="button" class="btn btn-danger btnclose" id="addEvent">x</button>
                                                    </div>
                                                </div>
