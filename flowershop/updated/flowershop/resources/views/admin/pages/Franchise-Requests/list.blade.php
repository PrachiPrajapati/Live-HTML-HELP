...
@push('breadcrumb')
    {!! Breadcrumbs::render('FranchiseRequest_list') !!}
@endpush
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase"> Total Franchises Requests : <span id="totalCount">{{ $count ?? 0 }}</span> </span>
                    </div>
                    <div class="actions">
                ...
                <div class="portlet-body">
                    <table class="table table-striped table-bordered table-hover table-checkable" id="franchisesrequestsList">
                    </table>
                </div>
            </div>
...
@push('extra-js')
    <script type="text/javascript">
        $(function(){
            var table = $('#franchisesrequestsList');
            ...
            oTable = table.dataTable({
                ...
                "columns": [
                    ...
                    { "title": "Phone" ,"data": "phone", render: $.fn.dataTable.render.text(),},
                ...
                "pageLength": 10,
                "ajax": {
                    "url": "{{route('admin.franchiserequests.listing')}}", // ajax source
                },
