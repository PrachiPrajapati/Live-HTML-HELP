            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase"> Total Boxes : <span id="totalCount">{{ $count ?? 0 }}</span> </span>
                    </div>
                    <div class="actions">
                        <div class="btn-group btn-group-devided">
                            @if (in_array('delete', $permissions))
                            <a href="{{ route('admin.box.destroy',0) }}" name="del_select" id="del_select" class="btn btn-sm btn-danger delete_all_link"><i class="fa fa-trash"></i> Delete Selected {{ $title }}</a>
                            @endif
                            @if (in_array('add', $permissions))
                            <a href="{{ route('admin.box.create') }}" class="btn btn-info">
                ...
                <div class="portlet-body">
                    <table class="table table-striped table-bordered table-hover table-checkable" id="boxsList">
                    </table>
                </div>
            </div>
        ...
        $(function(){
            ...
            oTable = table.dataTable({                
                ...
                "columns": [
                    ...
                    { "title": "Sub-Box" ,"data": "subbox_count", render: $.fn.dataTable.render.text(),},
                ...
                "pageLength": 10,
                "ajax": {
                    "url": "{{route('admin.box.listing')}}", // ajax source
                },
                ...
                "dom": "<'row' <'col-md-12'>><'row'<'col-md-6 col-sm-12'l><'col-md-6 col-sm-12'f>r><'table-scrollable't><'row'<'col-md-3 col-sm-12'i><'col-md-7 col-sm-12'p>>", // horizobtal scrollable datatable
            });
