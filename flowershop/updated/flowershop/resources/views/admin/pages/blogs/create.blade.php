...
@push('breadcrumb')
    {!! Breadcrumbs::render('blogs_create') !!}
@endpush
	...
	<div class="row">
        <div class="col-md-12">
            <div class="profile-content">
                <form action="{{ route('admin.blogs.store') }}" role="form" id="frmAddNewUser" name="frmAddNewUser" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-6">
                        <div class="portlet light ">
                            ...
                            <div class="portlet-body">
                                    ...
                                    <div class="form-group {{ $errors->has('en_title') ? 'has-error' : '' }}">
                                        ...
                                        <input type="text" placeholder="Enter Blog Title Here" class="form-control" id="en_title" name="en_title" maxlength="50" autocomplete="off" value="{{ old('en_title', '') }}" />
                                    ...
                                    <div class="form-group {{ $errors->has('en_short_description') ? 'has-error' : '' }}">
                                        ...
                                        <textarea placeholder="Enter Short Description Here" class="form-control" id="en_short_description" name="en_short_description"  autocomplete="off">{{ old('en_short_description', '') }}</textarea>
                                    ...
                                    <div class="form-group {{ $errors->has('en_description') ? 'has-error' : '' }}">
                                        ...
                                        <textarea placeholder="Enter Short Description Here" class="form-control" id="en_description" name="en_description"  autocomplete="off" data-error-container="#error-en-description">{!! old('en_description', '') !!}</textarea>
                        ...
                        <div class="portlet light ">
                            ...
                            <div class="portlet-body">
                                    ...
                                    <div class="form-group {{ $errors->has('ar_title') ? 'has-error' : '' }}">
                                        <label class="control-label">{!! $mend_sign !!}Title</label>
                                        <input type="text" placeholder="Enter Blog Title Here" class="form-control" id="ar_title" name="ar_title" maxlength="50" autocomplete="off" value="{{ old('ar_title', '') }}" />
                                    ...
                                    <div class="form-group {{ $errors->has('ar_short_description') ? 'has-error' : '' }}">
                                        <label class="control-label">{!! $mend_sign !!}Short Description</label>
                                        <textarea placeholder="Enter Short Description Here" class="form-control" id="ar_short_description" name="ar_short_description"  autocomplete="off">{{ old('ar_short_description', '') }}</textarea>
                                    ...
                                    <div class="form-group {{ $errors->has('ar_description') ? 'has-error' : '' }}">
                                        <label class="control-label">{!! $mend_sign !!}Description</label>
                                        <textarea placeholder="Enter Short Description Here" class="form-control" id="ar_description" name="ar_description" autocomplete="off" data-error-container="#error-ar-description">{{ old('ar_description', '') }}</textarea>
