            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase"> Total Blogs : <span id="totalCount">{{ $count ?? 0 }}</span> </span>
                    </div>
                    <div class="actions">
                        <div class="btn-group btn-group-devided">
                            @if (in_array('delete', $permissions))
                            <a href="{{ route('admin.blogs.destroy',0) }}" name="del_select" id="del_select" class="btn btn-sm btn-danger delete_all_link"><i class="fa fa-trash"></i> Delete Selected {{ $title }}</a>
                            @endif
        ...
        $(function(){
            ...
            oTable = table.dataTable({
                ...
                "columns": [
                    ...
                    @endif
                    { "title": "Blog Title" ,"data": "en_title", render: $.fn.dataTable.render.text(),},
