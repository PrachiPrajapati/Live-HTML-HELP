...
<div class="row">
    <div class="col-md-12">
        <form action="{{ route('admin.product.store') }}" id="frmAddNewProduct" name="frmAddNewProduct" role="form" action="{{ route('admin.product.store') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="portlet light bordered bg-blue-chambray bg-font-blue-chambray">
                                ...
                                <div class="form-group">
                                    <label class="control-label"><span class="mendatory">*</span>Product
                                        Title</label>
                                    <input type="text" name="en_title" placeholder="Enter Product Title" value="{{ old('en_title') }}" class="form-control" maxlength="50" autocomplete="off">
                                ...
                                <div class="form-group">
                                    <label class="control-label"><span class="mendatory">*</span>Product
                                        Description</label>
                                    <textarea class="form-control" name="en_description" placeholder="Enter Product Details" rows=5>{{ old('en_description') }}</textarea>
                        ...
                        <div class="col-md-6">
                            <div class="portlet light bordered bg-blue-chambray bg-font-blue-chambray">
                                ...
                                <div class="form-group">
                                    <label class="control-label"><span class="mendatory">*</span>Product
                                        Title</label>
                                    <input type="text" name="ar_title" placeholder="Enter Product Title" value="{{ old('ar_title') }}" class="form-control" maxlength="50" autocomplete="off">
                                ...
                                <div class="form-group">
                                    <label class="control-label"><span class="mendatory">*</span>Product
                                        Description</label>
                                    <textarea class="form-control" name="ar_description" placeholder="Enter Product Details" rows=5>{{ old('ar_description') }}</textarea>
                        ...
                        <div class="row flex-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name="sku" placeholder="Enter SKU" class="form-control"
                                    maxlength="50" autocomplete="off" value="{{ old('sku') }}">
                                @if($errors->has('sku'))
                                    <span class="help-block">
                                        {{ $errors->first('sku') }}
                                    </span>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name="list_price" placeholder="Enter List Price" class="form-control"
                                    maxlength="50" autocomplete="off" value="{{ old('list_price') }}">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name="your_price" placeholder="Enter Your Price" class="form-control"
                                    maxlength="50" autocomplete="off" value="{{ old('your_price') }}">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name="weight" placeholder="Enter Weight" class="form-control"
                                    maxlength="50" autocomplete="off" value="{{ old('weight') }}">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name="total_stock" placeholder="Enter Total Stock" class="form-control"
                                    maxlength="50" autocomplete="off" value="{{ old('total_stock') }}">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name="minimum_qty" placeholder="Enter Minimum Quantity"
                                    class="form-control" maxlength="50" autocomplete="off" value="{{ old('minimum_qty') }}">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name="order_amount" placeholder="Enter Order Amount" class="form-control"
                                    maxlength="50" autocomplete="off" value="{{ old('order_amount') }}">
                            ...
                            <div class="form-group col-md-4">
                                <label class="control-label"><span class="mendatory">*</span>Product
                                    Image</label>
                                <div class="upload prod-image mainImage">
...
@push('extra-js')
    ...
    <script type="text/javascript">
        ...
        $(document).on("click",".btnAddColor",function(){
                        ...
                        '<div class="row">'+
                            ...
                            '<div class="form-group col-md-6 col-lg-5">'+
                                ...
                                '<div class="upload multiple" id="file-'+count+'">'+
                                    '<input type="file"  name="color_image['+count+']" class="file-upload" accept="image/*" multiple>'+
                                '</div>'+
           ...
           // Turn input element into a pond
            $('#file-'+count).find('input').filepond({
                allowReorder: true,
                imagePreviewHeight: 130
            });
