            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase"> Total Products : <span id="totalCount">{{ $count ?? 0 }}</span> </span>
                    </div>
                    <div class="actions">
                        <div class="btn-group btn-group-devided">
                            @if (in_array('delete', $permissions))
                            <a href="{{ route('admin.product.destroy',0) }}" name="del_select" id="del_select" class="btn btn-sm btn-danger delete_all_link"><i class="fa fa-trash"></i> Delete Selected {{ $title }}</a>
                            @endif
                            ...
                            @endif
                            {{-- <a href="javascript:;"  data-toggle="modal" data-target="#csvupload" class="btn btn-sm btn-info">CSV Upload</a> --}}
                        </div>
                    </div>
                </div>
                <div class="portlet-body">
                    <table class="table table-striped table-bordered table-hover table-checkable" id="colosList">
                    </table>
                </div>
            </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                      ...
                      <h4 class="modal-title">Upload Multiple Products</h4>
                    </div>
                    <div class="modal-body">
                        <form id="frmUploadCsv" class="form-horizontal" role="form" method="POST" action="{{ route('admin.product.csv-upload') }}" enctype="multipart/form-data">
                            @csrf 
                            <div class="row">
                                <div class="col-md-10">
                                    {{-- Select File --}}
                                    ...
                                    {{-- Sample CSV Download --}}
                                    <a href="{{ route('admin.product.csv-download') }}">Download sample CSV</a>
        ...
        $(function(){
            ...
            oTable = table.dataTable({
                ...
                "columns": [
                    ...
                    @endif
                    { "title": "Title" ,"data": "title", render: $.fn.dataTable.render.text(),},
                ...
                "pageLength": 10,
                "ajax": {
                    "url": "{{route('admin.product.listing')}}", // ajax source
                },
