...
@push('breadcrumb')
    {!! Breadcrumbs::render('faqs_update') !!}
@endpush
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="profile-content">
                <form action="{{ route('admin.faqs.update', $faqs->id) }}" role="form" id="frmUpdateFaqs" name="frmUpdateFaqs" method="POST" enctype="multipart/form-data">
                    @csrf @method('PUT')
                    <div class="col-md-6">
                        <div class="portlet light ">
                            ...
                            <div class="portlet-body">
                                    ...
                                    <div class="form-group {{ $errors->has('en_question') ? 'has-error' : '' }}">
                                        ...
                                        <input type="text" placeholder="Enter Question Here" class="form-control" id="en_question" name="en_question" maxlength="255" autocomplete="off" value="{{ $faqs->en_question}}" />
                                    ...
                                    <div class="form-group {{ $errors->has('en_answer') ? 'has-error' : '' }}">
                                        ...
                                        <textarea rows="5" placeholder="Enter Answer Here" class="form-control" id="en_answer" name="en_answer"  autocomplete="off">{{ $faqs->en_answer }}</textarea>
                        ...
                        <div class="portlet light ">
                            ...
                            <div class="portlet-body">
                                    ...
                                    <div class="form-group {{ $errors->has('ar_question') ? 'has-error' : '' }}">
                                        <label class="control-label">{!! $mend_sign !!}Question</label>
                                        <input type="text" placeholder="Enter Question Here" class="form-control" id="ar_question" name="ar_question" maxlength="255" autocomplete="off"  value="{{ $faqs->ar_question}}"/>
                                    ...
                                    <div class="form-group {{ $errors->has('ar_answer') ? 'has-error' : '' }}">
                                        <label class="control-label">{!! $mend_sign !!}Answer</label>
                                        <textarea rows="5" placeholder="Enter Answer Here" class="form-control" id="ar_answer" name="ar_answer"  autocomplete="off">{{ $faqs->ar_answer }}</textarea>
