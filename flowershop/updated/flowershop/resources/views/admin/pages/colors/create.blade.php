...
@push('breadcrumb')
    {!! Breadcrumbs::render('color_create') !!}
@endpush
...
<div class="row">
        <form action="{{ route('admin.color.store') }}" role="form" id="frmAddNewColor" name="frmAddNewColor" method="POST" enctype="multipart/form-data" novalidate="novalidate">
        @csrf
            <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" placeholder="Enter Color Title" value="{{ old('value') }}" class="form-control" name="en_title" maxlength="50" autocomplete="off">
                    ...
                    <div class="profile-content">
                        <div class="col-md-12">
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label class="control-label"><span class="mendatory">*</span>Color Title</label>
                                    <input type="text" placeholder="Enter Color Title" value="{{ old('value') }}" class="form-control" name="ar_title" maxlength="50" autocomplete="off">
...
@push('extra-js')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#frmAddNewColor').submit(function(){
                if( $(this).valid() ){
                    addOverlay();
