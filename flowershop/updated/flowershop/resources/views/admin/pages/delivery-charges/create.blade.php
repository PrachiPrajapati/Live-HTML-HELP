...
@push('breadcrumb')
    {!! Breadcrumbs::render('delivery_charges_create') !!}
@endpush
	...
	<div class="row">
        <div class="col-md-12">
            <div class="profile-content">
                <form action="{{ route('admin.delivery-charges.store') }}" role="form" id="frmAddNewUser" name="frmAddNewUser" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-6">
                        <div class="portlet light ">
                            ...
                            <div class="portlet-body">
                                    ...
                                    <div class="form-group {{ $errors->has('country_id') ? 'has-error' : '' }}">
                                        <label class="control-label">{!! $mend_sign !!}Country Name</label>
                                    ...
                                    <div class="form-group {{ $errors->has('en_city') ? 'has-error' : '' }}">
                                        ...
                                        <input type="text" placeholder="Enter City Name Here" class="form-control" id="en_city" name="en_city" maxlength="50" autocomplete="off" />
                                    ...
                                    <div class="form-group {{ $errors->has('minimum_amount') ? 'has-error' : '' }}">
                                        ...
                                        <input type="number" placeholder="Enter Minimum Amount Here" class="form-control" id="minimum_amount" name="minimum_amount" maxlength="50" autocomplete="off" />
                                    ...
                                    <div class="form-group {{ $errors->has('charges') ? 'has-error' : '' }}">
                                        ...
                                        <input type="number" placeholder="Enter Charges Details Here" class="form-control" id="charges" name="charges" maxlength="50" autocomplete="off" />
                        ...
                        <div class="portlet light ">
                            ...
                            <div class="portlet-body">
                                    ...
                                    <div class="form-group {{ $errors->has('ar_city') ? 'has-error' : '' }}">
                                        <label class="control-label">{!! $mend_sign !!}City Name</label>
                                        <input type="text" placeholder="Enter City Name Here" class="form-control" id="ar_city" name="ar_city" maxlength="50" autocomplete="off" />
