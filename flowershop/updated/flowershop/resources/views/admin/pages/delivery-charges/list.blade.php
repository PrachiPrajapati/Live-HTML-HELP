...
@push('breadcrumb')
    {!! Breadcrumbs::render('delivery_charges_list') !!}
@endpush
                ...
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <div class="btn-group btn-group-devided">
                            ...
                            <a href="{{ route('admin.delivery-charges.destroy',0) }}" name="del_select" id="del_select" class="btn btn-sm btn-danger delete_all_link"><i class="fa fa-trash"></i> Delete Selected {{ $title }}</a>
                            @endif
                            @if (in_array('add', $permissions))
                            <a href="{{ route('admin.delivery-charges.create') }}" class="btn btn-info">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                      ...
                      <h4 class="modal-title">Upload Multiple Charges</h4>
                    </div>
                    <div class="modal-body">
                        <form id="frmUploadCsv" class="form-horizontal" role="form" method="POST" action="{{ route('admin.delivery-charges.csv-upload') }}" enctype="multipart/form-data">
                            @csrf 
                            <div class="row">
                                <div class="col-md-10">
                                        {{-- Select File --}}
        ...
        $(function(){
            ...
            oTable = table.dataTable({
                ...
                "columns": [
                    ...
                    @endif
                    { "title": "Name (English)" ,"data": "en_city", render: $.fn.dataTable.render.text(),},
                    { "title": "Minimum Amount" ,"data": "minimum_amount", render: $.fn.dataTable.render.text(),},
                    { "title": "Charges" ,"data": "charges", render: $.fn.dataTable.render.text(),},
                ...
                "pageLength": 10,
                "ajax": {
                    "url": "{{route('admin.delivery-charges.listing')}}", // ajax source
                },
