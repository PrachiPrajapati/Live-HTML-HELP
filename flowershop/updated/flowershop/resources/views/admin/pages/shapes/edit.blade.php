...
@push('breadcrumb')
    {!! Breadcrumbs::render('shape_update') !!}
@endpush
...
<div class="row">
        <form id="frmEditShape" name="frmEditShape" role="form" method="POST" action="{{ route('admin.shape.update',$shape->custom_id) }}" enctype="multipart/form-data" novalidate="novalidate">
        @csrf
        @method('PUT')
            <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="title" class="form-control" value="{{ old('title', $shape->title) }}" placeholder="Enter Shape Title">
                                    @if($errors->has('title'))
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="height" class="form-control" value="{{ old('height', $shape->height) }}" placeholder="Enter Shape Height">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="width" class="form-control" value="{{ old('width', $shape->width) }}" placeholder="Enter Shape Width">
                                    @if($errors->has('width'))
                                        <span class="help-block">
                                            {{ $errors->first('width') }}
                                        </span>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="depth" class="form-control" value="{{ old('depth', $shape->depth) }}" placeholder="Enter Shape Depth">
                                    @if($errors->has('depth'))
                                        <span class="help-block">
                                            {{ $errors->first('depth') }}
                                        </span>
                    ...
                    <div class="profile-content">
                        <div class="col-md-12">
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label class="control-label"><span class="mendatory">*</span>Shape Title</label>
                                    <input type="text" name="ar_title" class="form-control" value="{{ old('ar_title',$shape->ar_title) }}" placeholder="Enter Shape Title">
