                                ...
                                <td style="padding: 80px 50px; text-align: center;">
                                    <table width="100%" cellspacing="0" cellpadding="0">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style=" font-family: 'Roboto', sans-serif; font-size: 16px; line-height: 30px;">
                                                    We have received your order and it is under process  
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style=" font-family: 'Roboto', sans-serif; font-size: 16px; line-height: 30px;">
                                            ...
                                            <tr>
                                                <td style=" font-family: 'Roboto', sans-serif; font-size: 16px; line-height: 30px;">
                                                    <br>If, for any reason, you wish to change or cancel your order, please inform us as soon as possible by reaching us at <a href="https://order@maisondesfleurs.com">order@maisondesfleurs.com </a> or +971 55 223 6866. Please give 24 hours’ notice before the requested delivery date otherwise we will not be able to cancel your order.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style=" font-family: 'Roboto', sans-serif; font-size: 16px; line-height: 30px;">
                                                    <br>In case of cancelation of the order within the 24hrs period, we will provide you with a credit note valid for 6 months, no cash refunds are permitted.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style=" font-family: 'Roboto', sans-serif; font-size: 16px; line-height: 30px;">
