                        ...
                        <div class="row">
                            <div class="col-md-6 col-xl-3">
                                <div class="form-group">
                                    <input type="text" name="en_name" class="form-control" placeholder="NAME" value="{{ old('en_name') }}">
                                    @if($errors->has('en_name'))
                                   		<span class="error-help">{{ $errors->first('en_name') }}</span>
                                	@endif
                                </div>
                            </div>
                            <div class="col-md-6 col-xl-3">
                            ...
                            <div class="col-md-6 col-xl-3">
                                <div class="form-group">
                                    <input type="text" name="en_address" class="form-control" placeholder="ADDRESS" value="{{ old('en_address') }}" >
                                     @if($errors->has('en_address'))
                                    	<span class="error-help">{{ $errors->first('en_address') }}</span>
                                	@endif
                                </div>
                            </div>
                        </div>
