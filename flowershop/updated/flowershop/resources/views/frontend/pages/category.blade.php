...
<div class="banner small-banner d-flex align-items-center" style="background-image: url({{ asset('frontend/images/category-banner.jpg') }});">
    <div class="gradient-overlay"></div>
    <div class="container pos-rel">
        <div class="row">
            <div class="col-md-6 col-lg-4">
                <h1>Category Page Headline Placeholder</h1>
                        ...
                        <ol class="breadcrumb" id="breadcrumb">
                            ...
                            @elseif($breadcumb_category != null && $box != null)
                                <li class="breadcrumb-item active" aria-current="page">
                                    <a href="{{ route('category',[$breadcumb_category_slug,$box->custom_id]) }}">{{ $breadcumb_category }}</a>
                                </li>
