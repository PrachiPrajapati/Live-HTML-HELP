...
<section class="cart-section common-spacing">
    <article class="container">
        <div class="row">
            ...
            <form class="common-form" id="frmCheckout" method="POST" action="{{ route('payment') }}">
                @csrf
                                        ...
                                        <td width="45%">
                                            <div class="cart-single-item">
                                                ...
                                                <div class="cart-single-item_detail">
                                                    ...
                                                    <p class="product-price">${{ $product->product->order_amount }}</p>
                                                </div>
                                            </div>
                                        </td>
                                        <td width="20%">
                ...
                <div class="order-summary" id="orderSummary">
                        <div class="order-summary-inner">
                            ...
                            <table width="100%">
                                ...
                                <tr>
                                    <td>Delivery</td>
                                    <td id="delivery_charge">${{ $delivery_charge }}</td>
                                </tr>
                                <tr>
                                    <td>VAT</td>
                                    <td id="vat">{{ $vat }} %</td>
