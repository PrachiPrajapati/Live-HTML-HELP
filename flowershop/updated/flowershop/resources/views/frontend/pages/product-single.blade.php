                    ...
                    <div class="col-lg-9">
                        <div class="product-single_slider"> 
                            <div class="product-single_nav">
                                <ul id="showColors">
                                    <li>
                                        ...
                                        <img src="{{ generateURL($product->image) }}" alt="thumb">
                                    </li>
                                </ul>
                            </div>
                            <div class="product-single_for" id="productMainImage">
                                <ul id="productMainUl">
                                    <li class="img-zoom">
                                        <a href="{{ generateURL($product->image) }}" data-image="{{ generateURL($product->image) }}" data-fancybox><img src="{{ generateURL($product->image) }}"  alt="product"></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="product-single-info">
                            ...
                            <div class="product-single-info_summary">
                                ...
                                <form id="frmAddToCart" method="post" action="{{ route('add-to-cart') }}">
                                    @csrf
                                    <h4><del class="product-old-amount">AED 600.00</del> AED {{ $product->order_amount }}.00</h4>
