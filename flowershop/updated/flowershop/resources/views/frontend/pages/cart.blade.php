                                            ...
                                            <td>
                                                ...
                                                <div class="cart-single-item_detail">
                                                    ...
                                                    <div class="d-flex align-items-center product-options">
                                                        ...
                                                        <p>${{ $product->product->order_amount }}</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <div class="col-md-4">
                                            <div class="products-list_item">
                                                ...
                                                <div class="products-list_details">
                                                    ...
                                                    <button type="button" class="btn-outline addToCartSingle" data-custom_id="{{ $product->custom_id }}" data-minqty="{{ $product->minimum_qty }}" >Add to Cart</button>
                                                </div>
                                            </div>
                                        </div>
                                        @endforeach
