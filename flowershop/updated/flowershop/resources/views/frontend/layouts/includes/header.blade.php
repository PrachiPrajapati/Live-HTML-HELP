        ...
        <div class="header-content_inner">
            ...
            <ul>
                @if(Auth::check() == "true")
                    <li class="dropdown nav-item">
                        <a href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{ asset('frontend/images/icon-user.svg') }}" alt="user"></a>
            ...
            <form class="header-form" method="GET" action="{{ route('search') }}">
                <div class="input-group">
                    <input type="text" class="form-control" name="search" value="{{ old('search') }}" placeholder="Search" aria-label="Search"
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
             <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="freshFlowers" role="button"
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{ $category->getTitle() }}</a>
                                            ...
                                            @if($boxes != null)
                                                ...
                                                @foreach($boxes as $box)
                                                    ...
                                                    <div class="dropdown-cat-1 cat-box">
                                                        <a href="{{ route('category',[$category->slug,$box->custom_id]) }}" class="cat-link">{{ $box->getTitle() }} </a>
                                                        <ul>
                                                            @if($shapes != null)
                                                                ...
                                                                @foreach($shapes as $shape)
                                                                    ...
                                                                    @if($sub_categories != null)
                                                                        ...
                                                                        @foreach($sub_categories as $sub_cat)
                                                                            ...
                                                                            <li>
                                                                                <a href="{{ route('category',[$category->slug,$box->custom_id,$shape->custom_id]) }}">{{ $shape->getTitle() }}</a>
                                                                            </li>
                                                                            @endif
