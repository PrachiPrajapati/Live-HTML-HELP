                ...
                <div class="table-responsive">
                    <table width="100%">
                        ...
                        @foreach($orders as $order)
                                    ...
                                    <td width="80%">
                                        <div class="cart-single-item">
                                            ...
                                            <div class="cart-single-item_detail">
                                                <p>
                                                    <a href="{{ route('product.show',$order->product->slug) }}">{{ $order->product->title }}</a>
                                                </p>
                            ...
                            @elseif($order->addon != null)
                                <tr>
                                    <td width="80%">
                                        <div class="cart-single-item">
                                            <div class="cart-single-item_image" style="background-image: url('{{ generateURL($order->addon->image) }}');">
                                            </div>
                                            <div class="cart-single-item_detail">
                                                <p>
                                                    {{ $order->addon->title }}
                                                </p>
                                                <p class="product-code">Product ID: #{{ $order->addon->sku }}</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                    ...
                    <tbody>
                        <tr>
                            <td width="80%" valign="top">
                                ...
                                <p>
                                    <strong>{{ $card_holder_name }}</strong><br/>
                                    <strong>**** **** **** {{ $card_last_4 }}</strong>
                                </p>
                            </td>
                            <td>
