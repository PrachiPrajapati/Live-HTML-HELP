	    ...
	    <article class="container">
	        <nav aria-label="breadcrumb">
	            <ol class="breadcrumb common-breadcrumb">
	                <li class="breadcrumb-item"><a href="index.html"><img src="images/home-icon.svg"></a></li>
	       ...
	       <div class="news-articles featured-article">
	            <div class="news-article_image">
	                <div class="common_image-box">
	                    <div class="dyn-img common_image" style="background-image: url('images/news-image.jpg');">
	                    </div>
	                </div>
	            </div>
	            <div class="featured-article_summary">
	                <div class="row">
	                    <div class="col-lg-6 col-xl-4">
	                        <h1><a href="news-inner.html">Latest news headline placeholder</a></h1>
	                        <p>Millions of people around the world have already made the place where their work happens</p>
	                        <a href="news-inner.html" class="view-btn">Read More <img src="images/arrow-right-white.svg" alt="arrow"></a>
	                    </div>
	                </div>
	            </div>
	       </div>
	        	...
	        	<div class="common-spacing">
	        	    <div class="container">
	        	        <div class="title-block has-subtitle">
	        	            <h4>{{ $year }}</h4>
	        	            <a href="view-all.html" class="view-btn">View All <img src="{{ asset('frontend/images/arrow-right-dark.svg') }}" alt="arrow"></a>
	        	        </div>
