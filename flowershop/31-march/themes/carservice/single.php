		...
		<div class="vc_row wpb_row vc_inner vc_row-fluid">
			<div class="page-header-left">
				...
				<h1><?php if(count($post_template_page_array) && isset($post_template_page))
					{
						echo '<a href="' . esc_url(get_permalink($post_template_page->ID)) . '" title="' . esc_attr__("News", 'carservice') . '">' . __("News", 'carservice') . '</a>';
					}
					else
						echo __("News", 'carservice');?></h1>
			</div>
