		...
		<div class="header">
			...
			<div class="header_right">
				<div class="description">
					...
					<h5><?php _e("Version 6.2", 'carservice'); ?></h5>
		...
		<div class="footer">
			<div class="footer_left">
				<ul class="social-list">
					<li><a target="_blank" href="<?php echo esc_url(__('http://www.facebook.com/QuanticaLabs/', 'carservice')); ?>" class="social-facebook" title="<?php esc_attr_e('Facebook', 'carservice'); ?>"></a></li>
