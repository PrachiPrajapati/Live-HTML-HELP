                            ...
                            @csrf
                                <div id="eventInformation">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <select class="form-select address-select" id="checkout_city" name="city_delivery" data-error-container="#logged-in-delivery-city">
                                                    <option value="" disabled="" selected="">SELECT EMIRATE / CITY</option>
                                                </select>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group"><input type="text" id="checkout_pincode" name="pincode_delivery" class="form-control" value="" placeholder="POSTAL CODE / ZIP"></div>
                                        </div>
                                        <div class="col-md-6">
                ...
                <div class="step-2 form-step">
                        <div class="billing-address">
                            ...
                            <div class="row change-delivery-address" style="display: none;">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" name="pincode" class="form-control" placeholder="POSTAL CODE / ZIP">
                    ...
                    <div class="step-3 form-step" id="paymentDiv">
                        ...
                        <div class="table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td width="20%">
                                            <ul>
                                                <li>QTY</li>
                                                <li>
                                                    <select class="form-select scrollbar_select product_qty" name="quantity" data-custom_id="{{ $product->custom_id }}" data-product_id="{{ $product->product->id }}">
                                        ...
                                        <td width="10%">
                                            <a href="javascript:;" class="remove_product" data-product_id="{{ $product->product->id }}" data-color="{{ $product->color_id }}" data-quantity="{{ $product->quantity }}">Remove</a>
                                        </td>
                                        <td width="20%">
                                            @if($product->color_id != null && $product->color != null)
                         ...
                         <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group input-focused desc" data-char="0/255">
...
<script type="text/javascript" src="{{ asset('frontend/js/jcf.scrollable.js') }}"></script>
     ...
     <script type="text/javascript">
       $(document).ready(function () {
        ...
        var cartScroll = $(' select.scrollbar_select ');
        ...
        jcf.refresh();
            ...
            // form select
            $(".step-1 .form-select:not(.address-select)").prepend("<option value='' selected='selected'></option>");
                        ...
                        $.ajax({
                            ...
                            success: function(Response){
                                if(Response.success){
                                    ...
                                    $("#checkout_city").empty();
                                    $("#checkout_city").append('<option value="" selected>SELECT EMIRATE / CITY</option>');
            ...
            $.ajax({
                    ...
                    success: function(Response){
                        if(Response.success){
                            ...
                            $("#billing_city").empty();
                            $("#billing_city").append('<option value="" selected>SELECT EMIRATE / CITY</option>');
